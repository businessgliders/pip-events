...
export const COLUMN_COLOR_CLASSES = {
  ...
  'Quoted':              'from-yellow-400/20 to-amber-300/20 border-amber-300/40',
  ...
  'Ghosted':             'from-slate-400/20 to-gray-300/20 border-gray-300/40',
...
export const COLUMN_HEADER_CLASSES = {
  ...
  'Quoted':              'bg-amber-500/30 border-amber-400/40',
  ...
  'Ghosted':             'bg-slate-500/30 border-slate-400/40',
