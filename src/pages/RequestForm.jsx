    ...
    <div className="min-h-screen" style={{background: 'linear-gradient(135deg, #fce4ec 0%, #fdf5f7 60%, #fce4ec 100%)'}}>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <section className="rounded-2xl p-6" style={glassCard}>
            <div className="flex items-center gap-2 mb-1">
              <span className="inline-flex items-center justify-center w-7 h-7 rounded-full" style={{background: 'linear-gradient(135deg, #fbe0e2, #f7b1bd)'}}><Wine className="w-4 h-4" style={{color: '#e86c84'}} /></span>
