  ...
  return (
    <div className="min-h-screen relative" style={{ background: '#f4b7c4' }}>
      <div className="relative" style={{ zIndex: 2 }}>
        ...
        <div className="sticky top-0 z-30 px-4 md:px-8 pt-3 md:pt-4 pb-2" style={{ background: '#f4b7c4' }}>
        ...
        {/* Footer */}
        <div className="mt-1 pb-1 flex items-center justify-center gap-2 flex-shrink-0">
          <img
          ...
          />
          <span className="text-[10px]" style={{ color: '#7a5555' }}>
